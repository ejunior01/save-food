import { ArrowLeft, Leaf, TrendingDown } from "lucide-react-native";
import {
  Pressable,
  ScrollView,
  StatusBar,
...
import { getExpiryStatus, useAppData } from "@app/context/AppDataContext";
            ...
            <View style={{ flexDirection: "row", gap: 10 }}>
              ...
              <View style={{ flex: 1, backgroundColor: theme.colors.canvas, borderRadius: 16, padding: 14 }}>
                <View style={{ flexDirection: "row", alignItems: "center", gap: 6, marginBottom: 6 }}>
                  ...
                  <Text style={{ fontFamily: theme.fontFamily.mono.regular, fontSize: 9, letterSpacing: 0.12 * 9, textTransform: "uppercase", color: theme.colors.muted }}>Tranquilos</Text>
                </View>
                <Text style={{ fontFamily: theme.fontFamily.display.italic, fontSize: 36, color: theme.colors.ink, lineHeight: 38 }}>
                  {stats.safe}
                </Text>
            ...
            <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 6 }}>
              <View>
                ...
                <Text style={{
                  ...
                  marginTop: 4,
                  lineHeight: 28,
                }}>Alimentos <Text style={{ fontStyle: "italic" }}>descartados.</Text></Text>
              </View>
        ...
        <View style={{ paddingHorizontal: 18, paddingBottom: 14 }}>
          <View style={{
            ...
            <Text style={{
              ...
              Sempre coloque os alimentos mais novos atrás dos mais antigos. Assim você consome o que vence primeiro naturalmente.
            </Text>
          </View>
        </View>
