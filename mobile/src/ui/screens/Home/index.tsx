import { ArrowUpRight, Bell, Clock, Leaf, Search } from "lucide-react-native";
import {
  Image,
  Pressable,
  ScrollView,
        ...
        <View style={{ position: "relative" }}>
          ...
          <View style={{
            ...
            <Text style={{
              ...
              fontSize: 9.5,
              color: theme.colors.ink,
            }}>{recipe.have}/{recipe.total} ingredientes</Text>
          </View>
        </View>
      ) : (
...
export function Home() {
  ...
  const { name: userName, plan } = useUserStore();
  ...
  return (
    <View style={{ flex: 1, backgroundColor: theme.colors.canvas }}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }} contentContainerStyle={{ paddingBottom: bottom + 60 }}>
        <View style={{
          paddingTop: top + 14,
          ...
          >
            <View style={{ width: 42, height: 42, borderRadius: 999, backgroundColor: theme.colors.block.pistachio, alignItems: "center", justifyContent: "center" }}>
              <Text style={{ fontFamily: theme.fontFamily.display.italic, fontSize: 16, color: theme.colors.ink }}>{initials}</Text>
            </View>
            <View style={{ gap: 2 }}>
        ...
        <View style={{ paddingHorizontal: 18, paddingTop: 14, paddingBottom: 6 }}>
          ...
          <Text style={{
            ...
            {counts.expired + counts.urgent} alimentos{"\n"}
            precisam de <Text style={{ fontStyle: "italic" }}>você.</Text>
          </Text>
          {featured && (
            <Pressable
              onPress={() => tabNavigation.navigate("Alerts")}
        ...
        <View style={{ paddingHorizontal: 18, paddingBottom: 8, flexDirection: "row", gap: 10 }}>
          ...
          >
            ...
            <Text style={{ fontFamily: theme.fontFamily.display.regular, fontSize: 20, color: theme.colors.ink, lineHeight: 24 }}>
              Sua <Text style={{ fontStyle: "italic" }}>família.</Text>
            </Text>
            <ArrowUpRight size={16} color={theme.colors.ink} strokeWidth={1.6} />
          </Pressable>
        </View>
