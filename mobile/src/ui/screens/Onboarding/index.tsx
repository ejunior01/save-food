...
const SLIDES = [
  {
    ...
    titleEnd: "\nmais economia.",
    body: "Saiba o que está prestes a vencer antes de virar desperdício. Alertas gentis em 30, 15 e 5 dias.",
  ...
  },
  {
    ...
    titleItalic: "tem.",
    titleEnd: "",
    body: "Receitas pensadas pra aproveitar o que está vencendo. Compras sem repetição — só o que falta em casa.",
...
export function Onboarding({ navigation }: Props) {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: theme.colors.canvas, paddingTop: top, paddingBottom: bottom }}>
      ...
      <View style={{ flex: 1, paddingHorizontal: 22, paddingTop: 24, gap: 12 }}>
        <Text style={{
          fontFamily: theme.fontFamily.display.regular,
          fontSize: 48,
          lineHeight: 50,
      ...
      <View style={{ paddingHorizontal: 22, paddingBottom: Math.max(bottom, 32), gap: 16 }}>
